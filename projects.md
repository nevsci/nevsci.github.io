...
**BOM:**  
3D printed parts (Download the files [**here**](../assets/projects/Photoreactor_STL.rar)!)  
...
![The 3D printed photoreactor overview](../assets/projects/photoreactor/Photoreactor.png "3D printed photoreactor")
...
![The 3D NMR tube stand doubling as a RBF stand](../assets/projects/NMRStand/Stand.jpg "Tube_stand")
</details>
...
(Download the STL file for the beaker with volume label [**here**](../assets/projects/PP_labware/Beaker_50mL_volume.stl)!) (And the STL file for the beaker without volume label [**here**](../assets/projects/PP_labware/Beaker_50mL.stl)!)

[You can also find this project on Printables](https://www.printables.com/)

![The polypropylene beaker with volume of 50 mL](../assets/projects/PP_labware/Combined.jpg "Polypropylene beaker")
...
(You can get the PDF of the guide [here](../assets/projects/QC/QC_guide_5_2026.pdf)!) . Currently it is in version from May 2026.
