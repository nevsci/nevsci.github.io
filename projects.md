...
### Small modular photoreactor

I was always curious about the photoreactors used in the field especialy so when it was made in house and tailored for specific research needs. There are plenty of creative and robust solution out there. Anything from water cooled block from machined aluminium, to karusel style systems or just a simple array with a grid for tubes. There are also solutions which should have beed never created in the first place.  Still to this day when I see a Kessil lamp randomly aiming at a flask or a vial while vasting about 97 % of photons I have a mild allergic reaction... Oh and there obviously needs to be a desk fan cooling the setup.
...
<details class="project" name="projects" markdown="1">
<summary><strong>Project A</strong></summary>
...
<details class="project" name="projects" markdown="1">
<summary><strong>Project B</strong></summary>
